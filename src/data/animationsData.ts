...
export const animationsData: { [key: string]: IAnimation[] } = {
    ...
    "tejido-vegetal": [
        {
            clip: "Celula",
            description: 'Los tejidos vegetales están formados por células que se unen para realizar diferentes funciones, como la fotosíntesis, el transporte de agua y el soporte estructural. ',
